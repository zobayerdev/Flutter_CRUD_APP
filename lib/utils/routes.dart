import 'package:crud_flutter/views/addProductScreen/add_product_screen.dart';
import 'package:crud_flutter/views/homeScreen/home_screen.dart';
import 'package:crud_flutter/views/updateProductScreen/update_product_screen.dart';
    ...
    final Map<String, WidgetBuilder> routes = {
      ...
      Routes.addProductScreen: (context) {
        DataRepository dataController =
            routeSettings.arguments as DataRepository;
      ...
      Routes.updateProductScreen: (context) {
        ...
        return UpdateProductScreen(
            dataController: routeData["dataRepository"],
